...
public class ObservationTerminology {
    ...
    ///
    public static let bodyLandmarksKeysToLabels = [
        VNRecognizedPointKey.bodyLandmarkKeyNose : "nose",
        VNRecognizedPointKey.bodyLandmarkKeyRightEye : "rightEye",
        VNRecognizedPointKey.bodyLandmarkKeyLeftEye: "leftEye",
        VNRecognizedPointKey.bodyLandmarkKeyRightEar: "rightEar",
        VNRecognizedPointKey.bodyLandmarkKeyLeftEar: "leftEar",
        VNRecognizedPointKey.bodyLandmarkKeyRightShoulder: "rightShoulder",
        VNRecognizedPointKey.bodyLandmarkKeyLeftShoulder: "leftShoulder",
        VNRecognizedPointKey.bodyLandmarkKeyRightElbow: "rightElbow",
        VNRecognizedPointKey.bodyLandmarkKeyLeftElbow: "leftElbow",
        VNRecognizedPointKey.bodyLandmarkKeyRightWrist: "rightWrist",
        VNRecognizedPointKey.bodyLandmarkKeyLeftWrist: "leftWrist"
    ]
    ...
    ///
    public static let handLandmarksKeysToLabels = [
        VNRecognizedPointKey.handLandmarkKeyWrist: "wrist",
        VNRecognizedPointKey.handLandmarkKeyIndexTIP: "indexTip",
        VNRecognizedPointKey.handLandmarkKeyIndexDIP: "indexDip",
        VNRecognizedPointKey.handLandmarkKeyIndexPIP: "indexPip",
        VNRecognizedPointKey.handLandmarkKeyIndexMCP: "indexMcp",
        VNRecognizedPointKey.handLandmarkKeyMiddleTIP: "middleTip",
        VNRecognizedPointKey.handLandmarkKeyMiddleDIP: "middleDip",
        VNRecognizedPointKey.handLandmarkKeyMiddlePIP: "middlePip",
        VNRecognizedPointKey.handLandmarkKeyMiddleMCP: "middleMcp",
        VNRecognizedPointKey.handLandmarkKeyRingTIP: "ringTip",
        VNRecognizedPointKey.handLandmarkKeyRingDIP: "ringDip",
        VNRecognizedPointKey.handLandmarkKeyRingPIP: "ringPip",
        VNRecognizedPointKey.handLandmarkKeyRingMCP: "ringMcp",
        VNRecognizedPointKey.handLandmarkKeyLittleTIP: "littleTip",
        VNRecognizedPointKey.handLandmarkKeyLittleDIP: "littleDip",
        VNRecognizedPointKey.handLandmarkKeyLittlePIP: "littlePip",
        VNRecognizedPointKey.handLandmarkKeyLittleMCP: "littleMcp",
        VNRecognizedPointKey.handLandmarkKeyThumbTIP: "thumbTip",
        VNRecognizedPointKey.handLandmarkKeyThumbIP: "thumbIp",
        VNRecognizedPointKey.handLandmarkKeyThumbMP: "thumbMp",
        VNRecognizedPointKey.handLandmarkKeyThumbCMC: "thumbCmc"
    ]
